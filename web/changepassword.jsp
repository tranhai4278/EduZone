                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="change-password-form m-b30" action = "changepassword" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            <button type="button" class="btn-secondry" onclick="location.href = 'profile';">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
