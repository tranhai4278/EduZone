                    ...
                    <ul class="nav navbar-nav">	
                        ...
                        <li class="nav-dashboard"><a href="javascript:;">Dashboard <i class="fa fa-chevron-down"></i></a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="admin/subjects.jsp">Subject</a></li>
...
<script>
    ...
    <%
        ...
        ArrayList<String> SubjectNameList = subjectDal.getAllSubjectNames();
        ArrayList<String> SubjectCodeList = subjectDal.getAllSubjectCodes();
