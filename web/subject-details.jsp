                                            ...
                                            <div class="teacher-bx">
                                                <div class="teacher-info">
                                                    <div class="teacher-thumb">
                                                        <img src="${subject.getU().getAvatarUrl()}" style="width: 54px; height: 54px" alt=""/>
                                                    </div>
                                                    <div class="teacher-name">
                                                        <h5>${subject.getU().getFullName()}</h5>
                                        ...
                                        <div class="courses-post">
                                            ...
                                            <div class="ttr-post-info">
                                                <div class="ttr-post-title ">
                                                    <h2 class="post-title">${subject.getSubjectName()}</h2>
                                                </div>
                                                <div class="ttr-post-text">
                                                    <h4>${subject.getSubjectCode()}</h4>
                                                </div>
                                            </div>
                                        </div>
