                                            ...
                                            <form class="edit-profile" method="post" action="addDiscussion">
                                                ...
                                                <div class="bottom-part">
                                                    <div class="description-section">
                                                        ...
                                                        <input id="title" type="text" name="title" value="" placeholder=" Title here..." style="height: 40px; width: 100%"/><br>
                                                        <br>
                                                        <label for="summernote" class="description-area">Description:</label>
                                                        <textarea id="summernote" name="summernote" style="width: 80%"></textarea>
                                                        <br>
                                                        <label for="datetime">Select Start Time and End Time:</label>
                                                        <br>
                                                        <input type="datetime-local" id="startdatetime" name="startDateTime"> - <input type="datetime-local" id="enddatetime" name="endDateTime">
                                                    </div>
                                                </div>
