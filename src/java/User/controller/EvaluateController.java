...
public class EvaluateController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(assignmentID + " " + classID + " " + traineeID + " " + markParam + " " + comment);
        String mess = null;
        String sucess = "Submission is evaluated sucessfully!";
        if (comment == null) {
            ...
            try {
                Double mark = Double.parseDouble(markParam);
                if (mark > 10 || mark < 0) {
