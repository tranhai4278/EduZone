            ...
            <div class="ttr-header-wrapper">
                ...
                <div class="ttr-header-right ttr-with-seperator">
                    ...
                    <ul class="ttr-header-navigation">
                        ...
                        <li>
                            <a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="<%= ((User) request.getAttribute("user")).getAvatarUrl() %>" width="32" height="32"></span></a>
                            <div class="ttr-header-submenu">
                                <ul>
                                ...
                                <form class="edit-profile m-b30" action="updateprofile" method="POST">
                                    <div class="">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <span class="ttr-user-avatar" style="width: 150px; height: 150px; display: block; margin: 0 auto;">
                                                    <img alt="" src="<%= ((User) request.getAttribute("user")).getAvatarUrl() %>" width="150" height="150">
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input class="form-control" type="text" name="email" placeholder="Email" value="<%= ((User) request.getAttribute("user")).getEmail() %>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
